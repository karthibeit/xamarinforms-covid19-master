    ...
    public class MainPageViewModel : BaseViewModel
    {
        ...
        private void SetTotalCountry(Country response)
        {
            if (response != null)
            {
                ...
                CountryConfirmed = response.cases.TransformLongToString();
                CountryRecovered = response.recovered.TransformLongToString();
                CountryDeaths = response.deaths.TransformLongToString();
        ...
        void InitData()
        {
            ...
            RecoveredHeader = TranslateExtension.TranslateText("RecoveredHeader");
            DeathsHeader = TranslateExtension.TranslateText("DeathsHeader");
            CountryISO2 = App.AppCultureInfo.Equals("ta-IN") ? "IN" : "USA";
            LastUpdateHeader = "------------------------------";
            GlobalConfirmed = "-";
            GlobalRecovered = "-";
            GlobalDeaths = "-";
